...
```
#### Вывод при заполении коллекции "Животные":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Рацион кормления":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Зона обитания":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Здание":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Сотрудник":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Вид":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Питание":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Территория зоопарка":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Обитание":
```
{
	"acknowledged" : true,
	"insertedIds" : [
...
```
#### Вывод при заполении коллекции "Обслуживание":
```
{
	"acknowledged" : true,
	"insertedIds" : [
