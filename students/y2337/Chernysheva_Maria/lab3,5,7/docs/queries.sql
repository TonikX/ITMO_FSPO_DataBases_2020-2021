...
/*3.2
Вывести всех проживающих, которые заехали после 2021.01.02 включительно,
а выехали до 2021.01.12 включительно*/
SELECT public."Residing".full_name AS residing_full_name, public."Accommodation".check_in_date,
public."Accommodation".check_out_date FROM public."Residing", public."Accommodation" WHERE
...
/*6.2
Вывести минимальную и максимальную цену за услугу гостиницы
для тех услуг, цена которых не ниже 151*/
...
/*7.1
Вывести максимальную цену за услугу гостиницы,
цена которой больше 1000, если такая есть*/
...
/*7.2
Вывести максимальную цену за услугу гостиницы,
цена которой больше 500, если такая есть*/
SELECT public."Services".type, MAX(public."Services".price) AS max_price
...
/*9.1
Вывести информацию об служащих и их графике уборки
...
/*9.2
Вывести id только тех служащих, которые учавствуют в уборке
