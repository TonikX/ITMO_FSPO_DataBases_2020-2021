...
| Работа | Ссылка на работу |
| ------ | ------ | 
| Лабораторная часть (документация) | [SQL-запросы](https://sofkot.github.io/clinika/php/) |
...
| Работа | Ссылка на работу |
| ------ | ------ | 
| Лабораторная часть (документация) | [SQL-запросы](https://sofkot.github.io/clinika/mongo/) |
