...
<body>
	...
	<div id="container">
		<form method="post" enctype="multipart/form-data" id="form-box">
			Логин : <input type="text" name="username" placeholder="Enter username" class="input" required/> <br/><br/>
			Пароль : <input type="password" name="password" placeholder="Enter password" class="input" required/> <br/><br/>
			<input class="register" type="submit" name="insert" value="REGISTER">
			<button class="back"><a href="index.php">BACK</a></button>
		</form>
	</div>
